...
GO
PRINT N'Rename refactoring operation with key  is skipped, element [dbo].[VetTable].[Id] (SqlSimpleColumn) will not be renamed to vetID';
...
BEGIN TRANSACTION
GO
PRINT N'Creating Table [dbo].[VetTable]...';
